...
\titleformat{\section}
  {\normalfont\Large\bfseries\heiti} % 设置节标题为：常规、大号、加粗、黑体
  {\thesection}
  {1em}
  {}
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter]{prop}{命题}
{%
	enhanced,
	breakable,
	colback = mypropbg,
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=section]{claim}{断言}
{%
	enhanced
	,breakable
	,colback = myg!10
...
\tcbuselibrary{theorems,skins,hooks}
\newtcbtheorem[number within=chapter]{exercise}{练习}
{%
	enhanced,
	breakable,
	colback = myexercisebg,
...
\newtcolorbox{note}[1][]{%
	...
	frame hidden,
	boxrule = 0sp,
	borderline west = {2pt}{0pt}{gray!80!black}, % 左侧竖线
	sharp corners,
	detach title,
	before upper = \tcbtitle\par\smallskip, % 标题置于顶行
	title=\textbf{注},
...
% 	\proof[\bfseries\heiti #1]%
% }{\endproof}

\newcommand{\mclm}[2]{\begin{myclaim}[#1]#2\end{myclaim}}
% \newenvironment{myclaim}[1][\claimname]{\proof[\bfseries\heiti #1]}{}
...
{\addvspace{30pt}%
	\begin{tikzpicture}[remember picture, overlay]%
		...
		\pgftext[left,x=-3.2cm,y=0.2cm]{\color{white}\Large\sc\bfseries\heiti 第\ \thecontentslabel\Large\sc\bfseries\heiti 章};%
	\end{tikzpicture}\color{doc!60}\large\sc\bfseries\heiti}%
{}
{}
{\;\titlerule\;\large\sc\bfseries\heiti 第 \thecontentspage \large\sc\bfseries\heiti 页
	\begin{tikzpicture}[remember picture, overlay]
		\draw[fill=doc!60,draw=doc!60] (2pt,0) rectangle (4,0.1pt);
	\end{tikzpicture}}%
\titlecontents{section}[3.7pc]
{\addvspace{2pt}}
{\heiti\contentslabel[\thecontentslabel]{2pc}}
{}
...
\renewcommand{\tableofcontents}{%
	\chapter*{%
	  \vspace*{-20\p@}%
	  \begin{tikzpicture}[remember picture, overlay]%
		  \pgftext[right,x=17.2cm,y=0.12cm]{\color{doc!60}\Huge\sc\bfseries\heiti \contentsname};%
		  \draw[fill=doc!60,draw=doc!60] (13.1,-.75) rectangle (20,1);%
		  \clip (13,-.75) rectangle (20,1);
		  \pgftext[right,x=17.2cm,y=0.12cm]{\color{white}\Huge\sc\bfseries\heiti \contentsname};%
	  \end{tikzpicture}}%
	\@starttoc{toc}}
\makeatother
